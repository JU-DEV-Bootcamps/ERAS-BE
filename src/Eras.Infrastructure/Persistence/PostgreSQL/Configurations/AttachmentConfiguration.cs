...
{
    public sealed class AttachmentConfiguration : IEntityTypeConfiguration<AttachmentEntity>
    {
        ...
        private static void ConfigureColumns(EntityTypeBuilder<AttachmentEntity> builder)
        {
