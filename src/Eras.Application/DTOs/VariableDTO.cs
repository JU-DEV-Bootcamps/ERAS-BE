...
public class VariableDTO
{
    ...
    [StringLength(100, MinimumLength = 2, ErrorMessage = "Variable name must be between 2 and 100 characters.")]
    [RegularExpression(@"^[a-zA-Z0-9\s\-_.]+$", ErrorMessage = "Variable name can only contain letters, numbers, spaces, dashes, underscores, and dots.")]
