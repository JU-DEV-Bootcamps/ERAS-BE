...
public class JURemissionMapperTest
{
    [Fact]
    public void ToDomain_Should_Map_Properties()
    {
        ...
        Assert.Equal(dto.SubmitterUuid, result.SubmitterUuid);
    ...
    public void ToDTO_Should_Map_Properties()
    {
        ...
        var entity = new JURemission
        {
            Id = 1,
            SubmitterUuid = "2Remission",
            Audit = audit
        };
        ...
        Assert.Equal(entity.SubmitterUuid, result.SubmitterUuid);
        Assert.Same(audit, result.Audit);
    }
