...
public class GroupInterventionMapperTest
{
    [Fact]
    public void Map_ShouldMapGroupIntervention()
    {
        GroupInterventionDto source = new()
        {
        ...
        GroupIntervention result = CreateSut().Map(source);
    ...
    private static GroupInterventionMapper CreateSut()
    {
        return new GroupInterventionMapper();
    }
}
