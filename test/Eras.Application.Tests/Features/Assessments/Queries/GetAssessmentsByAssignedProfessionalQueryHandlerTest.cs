...
public class GetAssessmentsByAssignedProfessionalQueryHandlerTests
{
    ...
    private readonly GetAssessmentsByAssignedProfessionalQueryHandler _handler;

    public GetAssessmentsByAssignedProfessionalQueryHandlerTests()
    {
        _mockRepository = new Mock<IAssessmentRepository>();
        _mockMapper = new Mock<IMapper<Assessment, AssessmentDto>>();

        _handler = new GetAssessmentsByAssignedProfessionalQueryHandler(
            _mockRepository.Object,
            _mockMapper.Object);
    }

    [Fact]
    public async Task Handler_ShouldGetAssessmentsByProfessionalAsync()
    {
        var query = new GetAssessmentsByAssignedProfessionalQuery("e8298efe-a6d0-4474-9607-dc5854115229");
        ...
        [
            new Assessment
            {
                ...
                Service = "Service1",
                AssignedProfessional = "e8298efe-a6d0-4474-9607-dc5854115229"
            },
             new Assessment
            {
                Id = 2,
        ...
        _mockRepository
            .Setup(r => r.GetByAssignedProfessionalAsync(It.IsAny<string>()))
        ...
        _mockRepository.Verify(
            r => r.GetByAssignedProfessionalAsync(It.IsAny<string>()),
            Times.Once);
    }
